...
* Buatlah data mahasiswa yang terdiri dari NIM, nama, kelas dan prodi. Minimal isikan 10 data mahasiswa, bebas.
* Tampilkan data mahasiswa tersebut dengan menerapkan perulangan (boleh dalam bentuk tabel atau yang lain, sesuai kreativitas).
* Urutkan secara ascending berdasarkan Nama.

# Format File Tugas #

* Buatlah project dalam 1 file php
* Nama file: 06_Kelas_NIM
